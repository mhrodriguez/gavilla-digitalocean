...
function wpb_wl_hook_quickview_link(){
	echo '<div class="wpb_wl_preview_area"><span class="wpb_wl_preview open-popup-link" data-mfp-src="#wpb_wl_quick_view_'.get_the_id().'" data-effect="mfp-zoom-in">'.__( 'Vista Rapida','woocommerce-lightbox' ).'</span></div>';
}

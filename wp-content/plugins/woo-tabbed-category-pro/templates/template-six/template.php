...
<style>
    .qc-tabs-style9 ul.qc_theme_six > li a {
    ...
    .qc-tabs-style9 ul.slick-slider li.active {
        background: <?php echo get_option('product_category_button_active_color');?> !important;
    }
...
<div class="qc-tabs-style9">
    <div class="qc-tabs-container">
        <div class="tabs">
            ...
            <ul class="tab-links qc_theme_six qc_nav_style_1 <?php if (get_option('category_style') == 1) echo " slick-class"; ?>">
                <?php if (get_option('show_all') == 1): ?>
                    <li href="#<?php echo get_option('show_all'); ?>"><a
                                data-show-sale="<?php echo $show_sale; ?>"
                                data-feature-only="<?php echo $featured_only; ?>"
                                data-offset="<?php echo get_option('product_number'); ?>" data-cat-id="all">All</a></li>
                <?php endif; ?>
                <?php foreach ($product_categories as $cat): ?>
                    <li href="#<?php echo $cat->term_id; ?>" class=""><a
                                data-show-sale="<?php echo $show_sale; ?>"
                                data-feature-only="<?php echo $featured_only; ?>"
            ...
            <div class="qc_tab_css_bg" style="background-color:<?php echo get_option('container_background_color') ?>">
                ...
                <div class="tab-content">
                    <?php if (get_option('show_all') == 1): ?>
                        <div id="<?php echo get_option('show_all'); ?>" class="tab">
                            ...
                            <section class="grid theme-six">
                                <?php while ($product_query->have_posts()) : $product_query->the_post(); ?>
                                    <?php $product = $wc_pf->get_product(get_the_ID());
                                    $product_stock_status = $product->get_stock_status();
                                    ?>
                                    <!-- Grid items -->
                                    <div class="pro_list_04">
                                        <div class="slider">
                                            <div class="pro_item_list"><?php echo $product->get_image('shop_catalog'); ?></div>
                                        ...
                                        <div class="meta">
                                            ...
                                            <?php if (get_option('product_title') == 1): ?>
                                                <h3 class="pro_title_04"><a
                                                            style="color: <?php echo get_option('product_title_text_color'); ?>;font-size: <?php echo get_option('change_title_text_size'); ?>px;"
                                                            href="<?php $product->get_permalink(); ?>"><?php echo $product->get_title(); ?></a>
                                                </h3>
                                            <?php endif; ?>

                                            <?php if (get_option('display_price') == 1): ?>
                                                <span style="font-size: <?php echo get_option('product_content_text_size'); ?>px; color: <?php echo get_option('product_content_text_color'); ?>;"
                                                      class="pro_price_04"><?php echo $product->get_price_html(); ?></span>
                                            <?php endif; ?>
                                        </div>
                                        <?php if ($product_stock_status != 'outofstock'){ ?>
                                            <ul class="pro_icon action action_button action_buy">
                                                <?php if (get_option('product_title') == 1): ?>

                                                    <li><a href="<?php echo $product->get_permalink(); ?>"><i
                                                                    class="fa fa-link"
                                                ...
                                                <div class="qc_quantity qc_qat_style_six">
                            ...
                            <?php if ($product_num > get_option('product_number')): ?>
                                ...
                                <div class="qcld-wootab-more-scroll-container" style="text-align:center">
                                    ...
                                    <button style="background-color: #3D9CD2 !important; color: white;" type="button"
                                            id="qcld-wootab-more-six-all"
                                            data-theme-name="theme-six"
                                            data-show-sale="<?php echo $show_sale; ?>"
                                            data-feature-only="<?php echo $featured_only; ?>"
                                            data-offset="<?php echo get_option('product_number'); ?>">
                    ...
                    <?php foreach ($product_categories as $cat): ?>
                        <div id="<?php echo $cat->term_id; ?>" class="tab">

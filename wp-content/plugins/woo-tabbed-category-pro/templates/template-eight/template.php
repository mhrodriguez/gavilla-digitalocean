...
<style>
    ...
    .qc-tabs-style13 ul.slick-slider > li {
        background-color: <?php echo get_option('product_category_filter_button_color');?> !important;
        color: <?php echo get_option('product_category_text_font_color');?> !important;
        font-size: <?php echo get_option('product_category_text_font_size');?>px !important;
    }

    .qc-tabs-style13 ul.slick-slider > li:hover {
        background: <?php echo get_option('product_category_filter_button_color_hover');?> !important;
    }

    .qc-tabs-style13 ul.slick-slider > li.current {
        background: <?php echo get_option('product_category_button_active_color');?> !important;

    }

    .qc-tabs-style13 ul.slick-slider > li::after {
        background: <?php echo get_option('product_category_filter_button_color_hover');?> !important;
    }
...
<div class="qc-tabs-style13">
    <div class="container">
        ...
        ?>
        <ul class="tabs theme-eight-ul qc_theme_eight tabs-widget-light qc_nav_style_1 <?php if (get_option('category_style') == 1) echo " slick-class"; ?>">
            ...
            <?php foreach ($product_categories as $cat): ?>
                <li data-offset="<?php echo get_option('product_number'); ?>"
                    data-cat-id="<?php echo $cat->term_id; ?>" class="tab-link qc_theme_seven"
                    data-show-sale="<?php echo $show_sale; ?>"
                    data-feature-only="<?php echo $featured_only; ?>"
                ...
                <div id="tab-<?php echo get_option('show_all'); ?>" class="tab-content">
                    <div class="qc-wootabs-section">
                        <div class="qc-wootabs-content-section">
                            ...
                            <ul class="qc_tabs_10_style theme-eight ">
                                <?php while ($product_query->have_posts()) :
                                    ...
                                    <li class="">
                                        <div class="qc_tabs_10_style_box">
                                            <div class="pro_img"><?php echo $product->get_image('shop_catalog') ?></div>
                                            <div class="qc-tabs-style13-hover">
                                                ...
                                                <?php if (get_option('display_price') == 1): ?>
                                                    <div style="font-size: <?php echo get_option('product_content_text_size'); ?>px; color: <?php echo get_option('product_content_text_color'); ?> !important;"
                                                         class="qc_price"><?php echo $product->get_price_html(); ?></div>
                                                <?php endif; ?>

                                                <?php if (get_option('display_rating') == 1): ?>

                                                    <div class="qc_ratting">
                                                ...
                                                <div class="qc_quantity qc_qat_style_eight">
                                                    ...
                                                    <?php if (get_option('add_cart_link') == 1): ?>
                                                        ...
                                                        <?php if ($product_stock_status != 'outofstock') { ?>
                                                            <a class="woo_tab_s_p_add_to_cart"
                                                               ...
                                                               href="<?php echo $wc_pf->get_product(get_the_ID())->add_to_cart_url(); ?>"><?php $add_to_cart_text = get_option('change_add_to_cart_button_text');
                        ...
                        <div class="qcld-wootab-more-scroll-container" style="text-align:center">
                            ...
                            <button style="background-color: #3D9CD2 !important; color: white;" type="button"
                                    id="qcld-wootab-more-eight-all"
                                    data-theme-name="theme-eight"
                                    data-show-sale="<?php echo $show_sale; ?>"
                                    data-feature-only="<?php echo $featured_only; ?>"
                                    ...
                                    <li class="">
                                        <div class="qc_tabs_10_style_box">
                                            ...
                                            <div class="qc-tabs-style13-hover">
                                                ...
                                                <?php if (get_option('display_price') == 1): ?>
                                                    <div style="font-size: <?php echo get_option('product_content_text_size'); ?>px; color: <?php echo get_option('product_content_text_color'); ?>;"
                                                         class="qc_price"><?php echo $product->get_price_html(); ?></div>
                                                <?php endif; ?>

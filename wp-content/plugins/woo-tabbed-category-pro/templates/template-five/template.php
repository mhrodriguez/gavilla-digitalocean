...
<style>
    ...
    .qc-tabs-style10 ul.qc_nav_style_1 li {
        ...
        color: <?php echo get_option('product_category_text_font_color');?> !important;
        font-size: <?php echo get_option('product_category_text_fontফ_size');?>px !important;
    }
...
<div class="qc-tabs-style10">
    <div class="qc_container">
        ...
        <ul class="tabs tabs-widget-light tabs-five qc_theme_five qc_nav_style_1 <?php if (get_option('category_style') == 1) echo " slick-class"; ?>">
            <?php if (get_option('show_all') == 1): ?>

                <li data-show-sale="<?php echo $show_sale; ?>"
            ...
            <?php foreach ($product_categories as $cat): ?>
                <li data-offset="<?php echo get_option('product_number'); ?>"
                    ...
                    data-feature-only="<?php echo $featured_only; ?>"
                    data-cat-id="<?php echo $cat->term_id; ?>" class="tab-link"
                ...
                <div id="tab-<?php echo get_option('show_all'); ?>" class="tab-content current">
                    <div class="qc-wootabs-section">
                        <div class="qc-wootabs-content-section">
                            ...
                            <ul class="qc_tabs_10_style theme-five ">
                                <?php while ($product_query->have_posts()) : $product_query->the_post(); ?>
                                    ...
                                    <li class="">
                                            ...
                                            <?php if (get_option('product_title') == 1): ?>
                                                <h2>
                                                    <a style="color: <?php echo get_option('product_title_text_color'); ?>;font-size: <?php echo get_option('change_title_text_size'); ?>px;"
                                                       href="<?php echo get_the_permalink(); ?>"><?php echo $product->get_title(); ?></a>
                                                </h2>
                                            <?php endif; ?>
                                        ...
                                        <?php if ($product_stock_status != 'outofstock') { ?>
                                            <div class="qc_tabs_10_style_box_hover">
                                                <div class="qc_tabs_10_style_box_details">
                                                    ...
                                                    <div class="qc_tabs_10_style_box_icon">
                                                        <ul>
                                                            ...
                                                            <?php if (get_option('product_title') == 1): ?>
                                                                <li><a href="<?php echo get_the_permalink(); ?>"><i
                                                                                class="fa fa-link"
                                                            ...
                                                            <div class="qc_quantity qc_qat_style_five">
                                                ...
                                                <div class="qc_tabs_10_style_box_details">
                                                    ...
                                                    <div class="qc_tabs_10_style_box_icon">
                                                        <ul>
                                                            ...
                                                            <div class="qc_out_of_stock_container qc_quantity qc_qat_style_five">
                            ...
                            <?php if ($product_num > get_option('product_number')): ?>
                                ...
                                <div class="qcld-wootab-more-scroll-container" style="text-align:center">
                                    ...
                                    <button style="background-color: #3D9CD2 !important; color: white;" type="button"
                                            id="qcld-wootab-more-five-all"
                                            data-theme-name="theme-five"
                                            data-show-sale="<?php echo $show_sale; ?>"
                                            data-feature-only="<?php echo $featured_only; ?>"
                                ...
                                <?php while ($product_query->have_posts()) : $product_query->the_post(); ?>
                                    ...
                                    <li class="">
                                        <div class="qc_tabs_10_style_box">
                                            ...
                                            <?php if (get_option('display_price') == 1): ?>
                                                <div class="qc_price"><?php echo $product->get_price_html(); ?></div>
                                            <?php endif; ?>
                                                ...
                                                <div class="qc_tabs_10_style_box_details">
                                                    ...
                                                    <div class="qc_tabs_10_style_box_icon">
                                                        <ul>
                                                            ...
                                                            <div class="qc_quantity qc_qat_style_five qc_out_of_stock_container">

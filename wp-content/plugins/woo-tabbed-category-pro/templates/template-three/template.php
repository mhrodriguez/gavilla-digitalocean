...
<style>
    .qc_theme_three {
        color: <?php echo get_option('product_category_text_font_color');
?> !important;
        font-size: <?php echo get_option('product_category_text_font_size');
?>px !important;
        background-color: <?php echo get_option('product_category_filter_button_color');?> !important;
    }

    .qc_theme_three.current {
...
<div class="qc-tabs-style2">
    <div class="container">
        ...
        ?>
        <ul class="wotabs_style2 qc_nav_style_1 <?php if (get_option('category_style') == 1) echo " slick-class"; ?> ">
            <?php if (get_option('show_all')): ?>
                <li class="tab-link qc_theme_three" data-cat-id="all" data-show-sale="<?php echo $show_sale; ?>"
                    data-feature-only="<?php echo $featured_only; ?>"
                    data-tab="tab-<?php echo get_option('show_all'); ?>"> All<span></span></li>
            <?php endif; ?>
            <?php foreach ($product_categories as $cat): ?>
                <li class="tab-link qc_theme_three" data-offset="<?php echo get_option('product_number'); ?>"
                        ...
                        <ul class="wootabs ">
                            <?php while ($product_query->have_posts()) : $product_query->the_post(); ?>
                                ...
                                <li class="">
                                    ...
                                    <?php endif; ?>
                                    <div class="wootabs_img"><?php echo $product->get_image('shop_catalog'); ?></div>
                                    ...
                                    <?php endif; ?>
                                    <div class="woo_price"
                                         style="font-size: <?php echo get_option('product_content_text_size'); ?>px; color: <?php echo get_option('product_content_text_color'); ?>;">
                    ...
                    <?php if ($product_num > get_option('product_number')): ?>
                        <div class="qcld-wootab-more-scroll-container" style="text-align:center">
                            ...
                            <button style="background-color: #3D9CD2 !important; color: white;" type="button"
                                    id="qcld-wootab-more-three-all"
                                    data-show-sale="<?php echo $show_sale; ?>"
                                    data-theme-name="theme-three"
                                    data-feature-only="<?php echo $featured_only; ?>"

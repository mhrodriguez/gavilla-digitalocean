...
class Cmsmasters_Content_Composer { 
	function __construct() { 
		define('CMSMASTERS_CONTENT_COMPOSER_VERSION', '2.1.3');
	...
	function cmsmasters_composer_enqueue_scripts($hook) {
		...
		/* Start cmsmasters_simple_icon and cmsmasters_icon_box Translations */
			...
			'icon_field_text_align_descr' =>					__('Choose horizontal position for your icon', 'cmsmasters-content-composer'),			'icon_field_border_width_title' =>					__('Icon Spacer Border Width', 'cmsmasters-content-composer'),

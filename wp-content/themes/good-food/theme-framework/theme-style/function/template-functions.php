	...
	if (
		...
		$out_form = "<form method=\"get\" action=\"" . esc_url(home_url('/')) . "\">
			<div class=\"cmsmasters_header_search_form_field\">
				...
				<input type=\"search\" name=\"s\" placeholder=\"" . esc_attr__('Ingresa b&uacute;squeda', 'good-food') . "\" value=\"\" />
			</div>
		</form>";
				...
				if ($cmsmasters_heading == 'custom') {
					...
					if (is_search()) {
						...
						if (!empty($wp_query->found_posts)) {
							echo sprintf(esc_html(_n('1 search result for: %2$s', '%1$d Resultados de: %2$s', $wp_query->found_posts, 'good-food')), $wp_query->found_posts, get_search_query());
						} else {
